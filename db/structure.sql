...
--
-- Name: index_posts_on_blog_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_posts_on_blog_id ON posts USING btree (blog_id);


--
-- Name: fk_rails_dda555d01f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY posts
    ADD CONSTRAINT fk_rails_dda555d01f FOREIGN KEY (blog_id) REFERENCES blogs(id);
